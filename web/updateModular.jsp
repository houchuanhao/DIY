    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <%
                ...
                String delSql="delete from Modular where id='"+delId+"'";
                ...
                while(resultSet.next()) {
                    ...
                    out.print("</p>");
                    out.print("<p>");
                    out.print("<a class=\"btn btn-primary\" href=\"doEditModular.jsp?id="+id+"\">编辑</a>");
                    out.print("<a class=\"btn btn-primary\" href=\"updateModular.jsp?id="+id+"\">删除</a>");
                    out.print("</p>");
                    out.print("</div>");
                    out.print("</div>");
                    out.print("</div>");
